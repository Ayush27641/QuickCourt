...
const UserManagement = () => {
  ...
  const _getSportNameById = async (sportId) => {
  ...
  const _getSportNameByVenueAndId = async (venueId, sportId) => {
    try {
  ...
  const _handleUnbanUser = async (userId) => {
    try {
              ...
              {loading ? (
                ...
                filteredUsers.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td>
                      <span
                        className={`${styles.statusTag} ${getStatusColor(user.status)}`}
                      >
                ...
                <div className={styles.userProfile}>
                  ...
                  <div className={styles.profileInfo}>
                    ...
                    <div className={styles.profileTags}>
                      ...
                      <span
                        className={`${styles.statusTag} ${getStatusColor(selectedUser.status)}`}
                      >
                        ...
                        <div className={styles.venueCard}>
                          <div className={styles.venueHeader}>
                            ...
                            <div className={styles.venueStatus}>
                              {/** backend returns isVerified (Prisma) */}
                              {(() => {
                                const verified =
                                    ...
                                    {venueDetails.photoUrls.map(
                                      (photoUrl, index) => (
                                        <img
                                          key={index}
                                          src={photoUrl}
                                          alt={`${venueDetails.name} photo ${index + 1}`}
